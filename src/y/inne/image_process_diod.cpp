...
ImageProcessing::ImageProcessing(ros::NodeHandle &nh) {
  ...
  distCoeffs.at<double>(0) = -0.412053;
  distCoeffs.at<double>(1) = 0.198101;
  distCoeffs.at<double>(2) = -0.001107;
  distCoeffs.at<double>(3) = -0.000319;
  distCoeffs.at<double>(4) = 0.0;

  cameraMatrix = cv::Mat(3, 3, cv::DataType<double>::type);
  cameraMatrix.at<double>(0, 0) = 1102.827984;
  cameraMatrix.at<double>(0, 1) = 0.0;
  cameraMatrix.at<double>(0, 2) = 656.555634;
  cameraMatrix.at<double>(1, 0) = 0.0;
  cameraMatrix.at<double>(1, 1) = 1096.119109;
  cameraMatrix.at<double>(1, 2) = 521.077625;
