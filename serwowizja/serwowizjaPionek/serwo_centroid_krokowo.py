...
#(1.10342843843-0.987109990995)*0.987109990995-0.0001476
	...
	wynik = (punkt_odniesienia_y - y_px)*0.00052632*0.2
...
def serwo():
	...
	while(licznik<30):
		...
		print y_cm
		#czas = abs(y_cm * 30)
		if ((y_cm < 0.05 and y_cm > -0.05) and not (y_cm < 0.001 and y_cm > -0.001) and y_px !=0):
			print "ok"
...
if __name__ == '__main__':
	#irpos = IRPOS("maciek", "Irp6p", 6, "irp6p_managers")
	#irpos = IRPOS("maciek", "Irp6ot", 7, "irp6ot_managers")
	irpos = IRPOS("maciek", "Irp6p", 6)
	#pozycja_startowa()
	#sterowanie_silowe()
	#wyswietl_aktualna_pozycje()
	#sterowanie_predkoscia(0.01)
	serwo()
