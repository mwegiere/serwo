...
def onInit():
	rospy.Subscriber('object_seen_by_camera',SerwoInfo, readHomogVector)
	global publisher
	publisher = rospy.Publisher('object_seen_by_camera', Marker,queue_size=10)
	rospy.init_node('object_seen_by_camera_rviz')	
